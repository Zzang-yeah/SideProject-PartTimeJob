...
import { AccountBtn, AuthWrapper, InfoContainer, SignupLogin, Title } from "../../common/commonStyle";
...
import { AuthInput, InfoWrap } from "../../common/AuthForm/style";
            ...
            <AuthWrapper>
                <InfoContainer>
                    ...
                    <InfoCard>
                        ...
                        {/* 회원가입 입력 */}
                        <AuthForm onSubmit={handleSubmit(individualSignup)}>
                            <InfoWrap>
                                <label>이메일</label>
                                <AuthSignupInput
                                    type='email'
